create table if not exists `spring-job-board`.`job-categories`
(
...
create table if not exists `spring-job-board`.skills
(
    id   int auto_increment
        primary key,
    name varchar(99) not null
...
create table if not exists `spring-job-board`.users
(
...
create table if not exists `spring-job-board`.applicants
(
    id          bigint auto_increment
        primary key,
...
create table if not exists `spring-job-board`.employers
(
    id      bigint auto_increment
        primary key,
    name    varchar(99) not null,
...
create table if not exists `spring-job-board`.skills_applicants
(
...
create table if not exists `spring-job-board`.users_roles
(
...
create table if not exists `spring-job-board`.vacancies
(
    id          bigint auto_increment
        primary key,
    created_at  datetime(6)                         null,
...
create table if not exists `spring-job-board`.`response-to-vacancies`
(
    id           bigint auto_increment
        primary key,
    applicant_id bigint      not null,
...
create table if not exists `spring-job-board`.skills_vacancies
(
    vacancy_id bigint not null,
    skill_id   int    not null,
...
create table if not exists `spring-job-board`.vacancies_categories
(
    vacancy_id bigint not null,
...
create table if not exists `spring-job-board`.vacancies_modes
(
    vacancy_id bigint                       not null,
...
create table if not exists `spring-job-board`.vacancies_types
(
    vacancy_id bigint                                                                not null,
